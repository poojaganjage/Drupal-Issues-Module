...
class ImageUrlFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, AccountInterface $current_user, LinkGeneratorInterface $link_generator, EntityStorageInterface $image_style_storage) {
