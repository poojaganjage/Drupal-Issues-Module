...
class EntityReferenceViewModeFieldWidget extends WidgetBase {
  ...
  public function availableEntityTypes() {
    ...
    // $all = \Drupal::entityTypeManager()->getEntityTypeLabels(TRUE)['Content'];
    $all = \Drupal::service('entity_type.repository')->getEntityTypeLabels(TRUE)['Content'];
  ...
  public function availableViewModes($target_type, $bundle) {
    ...
    $all_view_modes = \Drupal::entityTypeManager()->getStorage('entity_view_mode')->loadMultiple();
