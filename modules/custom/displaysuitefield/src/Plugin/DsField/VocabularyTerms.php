...
namespace Drupal\displaysuitefield\Plugin\DsField;
 ...
 * @DsField(
 *   id = "vocabulary_terms",
 *   title = @Translation("Vocabulary Taxonomy Terms"),
 *   entity_type = "node",
 *   provider = "displaysuitefield",
 *   ui_limit = {"article|*"}
 * )
 */
class VocabularyTerms extends DsFieldBase {
  ...
  public function build() {
    ...
    return array(
      // '#theme' => 'displaysuitefield_items_list',
      '#items' => $this->buildTermList($terms), // Display suite not allowed to display content and widget.
    );
  }

  /**
   * Builds a term list to be used with #theme => 'displaysuitefield_items_list
   *
   * @param array $terms
   * @return array
   */
